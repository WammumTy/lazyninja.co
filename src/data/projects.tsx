export const projects = [
    {
      id: 1,
      title: "AI Powered Facial Detection",
      category: "AI/ML",
      progress: "Completed",
      image: "/pics/projects/1742832961742.webp",
      git: "https://github.com/WammumTy",
      description: "A local application that uses AI to detect and analyze facial features in real-time.",
      details: "This project was built with the help of MSU Ai Club to help me better understand the concepts of AI and ML. It uses mediapipe and OpenCV to detect faces in real-time. The application is built using Python."
    },
    {
      id: 2,
