      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-700 mb-4">
            I am working on bettering my local community by creating stunning, advanced, projects that will improve their digital identity of their business. If you are a small business looking for a way to stand out from the average business.
          </p>
          <Button
